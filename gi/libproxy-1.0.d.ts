...
interface ProxyFactory {
    ...
    // Owm methods of Libproxy-1.0.Libproxy.ProxyFactory
     ...
     */
    get_proxies(url: string | null): string[]
}

class ProxyFactory {

    // Own properties of Libproxy-1.0.Libproxy.ProxyFactory

    static name: string

    // Constructors of Libproxy-1.0.Libproxy.ProxyFactory
