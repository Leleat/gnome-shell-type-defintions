...
interface DA_MEMCPY2D {
    ...
    // Own fields of CudaGst-1.0.CudaGst.DA_MEMCPY2D
...
class DA_MEMCPY2D {
    ...
    // Own properties of CudaGst-1.0.CudaGst.DA_MEMCPY2D
...
interface DA_RESOURCE_DESC {
    ...
    // Own fields of CudaGst-1.0.CudaGst.DA_RESOURCE_DESC
...
class DA_RESOURCE_DESC {
    ...
    // Own properties of CudaGst-1.0.CudaGst.DA_RESOURCE_DESC
...
interface DA_RESOURCE_VIEW_DESC {
    ...
    // Own fields of CudaGst-1.0.CudaGst.DA_RESOURCE_VIEW_DESC
...
class DA_RESOURCE_VIEW_DESC {
    ...
    // Own properties of CudaGst-1.0.CudaGst.DA_RESOURCE_VIEW_DESC
...
interface DA_TEXTURE_DESC {
    ...
    // Own fields of CudaGst-1.0.CudaGst.DA_TEXTURE_DESC
...
class DA_TEXTURE_DESC {
    ...
    // Own properties of CudaGst-1.0.CudaGst.DA_TEXTURE_DESC
